...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Edit GlobalUser', true), array('action' => 'edit', $globalUser['GlobalUser']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete GlobalUser', true), array('action' => 'delete', $globalUser['GlobalUser']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $globalUser['GlobalUser']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List GlobalUsers', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New GlobalUser', true), array('action' => 'add')); ?> </li>
	</ul>
</div>
