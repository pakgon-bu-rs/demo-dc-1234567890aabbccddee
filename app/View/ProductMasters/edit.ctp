...
<?php echo $this->Form->create('ProductMaster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Product Master'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProductMaster.style')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProductMaster.style'))); ?></li>
